...
function KanbanBoard({ samples, customerName, materialPreps, moveStage, onBulkMove, onBulkDelete, onAddSample, onCardClick }) {
...
function KanbanCard({ sample: s, customerName, onClick, onToggleSelect, selected, onDragStart, onDragEnd, isDragging, onMoveStage, stageTheme, materialReadiness }) {
  const ot = sampleOnTime(s);
