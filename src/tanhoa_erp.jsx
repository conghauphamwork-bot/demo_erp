...
import { LayoutDashboard, Users, FileText, ShoppingCart, Boxes, CalendarDays, Palette, Truck, Plus, X, Image as ImageIcon, Search, ListTodo, Download } from "lucide-react";
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ display: "flex", gap: 8 }}><Button small variant="subtle" onClick={() => setShowExport(true)}><Download size={14} /> Export</Button><Button onClick={startNew}><Plus size={15} /> New sample</Button></div>
      </div>
