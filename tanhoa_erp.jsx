...
import { LayoutDashboard, Users, FileText, ShoppingCart, Boxes, CalendarDays, Palette, Truck, Plus, X, Image as ImageIcon, Search, ListTodo, Download, Upload, FileSpreadsheet, CheckCircle2, AlertCircle, Trash2, CheckSquare, Square, Move, QrCode as QrCodeIcon, Sparkles } from "lucide-react";
...
function Panel({ title, action, children }) {
  return (
    <div className="erp-panel" style={{ background: COLORS.panel, border: `1px solid ${COLORS.line}`, borderRadius: 14, overflow: "hidden", boxShadow: "0 1px 2px rgba(0,0,0,.025), 0 8px 24px rgba(35,42,38,.035)" }}>
      {(title || action) && (
        <div
          style={{
            display: "flex",
...
function Table({ columns, rows, onRowClick, empty }) {
  ...
  return (
    <div className="erp-table-wrap">
      <table className="erp-data-table" style={{ width: "100%", borderCollapse: "collapse", fontSize: 13.5 }}>
        <thead>
          <tr>
            {columns.map((c) => (
              <th
        ...
        <tbody>
          {rows.map((row, i) => (
            ...
            >
              {columns.map((c) => (
                <td key={c.key} data-label={c.label || ""} style={{ padding: "9px 10px", textAlign: c.align || "left", verticalAlign: "middle" }}>
      ...
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media (min-width: 1281px) {
          .sample-kanban-column-body { padding: 7px !important; gap: 7px !important; }
          .sample-kanban-card { padding: 8px !important; gap: 7px !important; border-radius: 11px !important; }
          .sample-kanban-card > div:nth-child(2) { gap: 6px !important; }
          .sample-kanban-card > div:nth-child(2) > div:first-child { width: 52px !important; height: 52px !important; margin-left: 21px !important; border-radius: 8px !important; }
          .sample-kanban-column > div:first-child { padding: 10px 9px 9px !important; gap: 7px !important; }
          .sample-kanban-column > div:first-child > div:first-child { gap: 6px !important; }
          .sample-kanban-column > div:first-child > div:first-child > div > div:first-child { font-size: 11px !important; white-space: normal !important; line-height: 1.15 !important; }
          .sample-kanban-column > div:first-child > div:first-child > span { min-width: 22px !important; height: 22px !important; font-size: 9px !important; }
        }
        /* --- Responsive layout system ---
           Goal: every normal form/table fits the viewport; only intentionally wide
           boards (Kanban/Calendar) use horizontal scrolling. */
        .erp-panel { min-width: 0; max-width: 100%; }
        .erp-panel > div { min-width: 0; }
        .responsive-grid { min-width: 0; width: 100%; }
        .responsive-grid > * { min-width: 0; }
        .erp-table-wrap { width: 100%; min-width: 0; overflow-x: auto; -webkit-overflow-scrolling: touch; }
        .erp-data-table { width: 100%; max-width: 100%; table-layout: fixed; }
        .erp-data-table th, .erp-data-table td { min-width: 0; overflow-wrap: anywhere; word-break: break-word; }
        .erp-data-table td > *, .erp-data-table th > * { max-width: 100%; }
        .erp-modal { width: min(1120px, calc(100vw - 32px)) !important; max-width: calc(100vw - 32px); }
        .erp-modal input, .erp-modal select, .erp-modal textarea { max-width: 100%; }
        .calendar-week-grid { min-width: 860px; }
        .calendar-week-body { min-width: 860px; }
        .kanban-board { min-width: 0; }

        @media (max-width: 1200px) {
          .erp-content { padding: 22px; }
          .responsive-grid-5 { grid-template-columns: repeat(3, minmax(0, 1fr)) !important; }
          .responsive-grid-4 { grid-template-columns: repeat(2, minmax(0, 1fr)) !important; }
        ...
        @media (max-width: 820px) {
          ...
          .erp-panel > div { padding-left: 14px !important; padding-right: 14px !important; }
          .responsive-grid-5,
          .responsive-grid-4,
          .responsive-grid-3,
          .responsive-grid-2 { grid-template-columns: minmax(0, 1fr) !important; }
          .erp-data-table { table-layout: auto; }
          .erp-table-wrap { overflow-x: visible; }
          .erp-data-table,
          .erp-data-table tbody,
          .erp-data-table tr,
          .erp-data-table td { display: block; width: 100%; }
          .erp-data-table thead { display: none; }
          ...
          .erp-data-table tbody tr:last-child { margin-bottom: 0; }
          ...
          .erp-data-table tbody td::before {
          ...
          .erp-data-table tbody td:last-child { border-bottom: 0 !important; }
          .erp-data-table tbody td:last-child::before { content: ""; }
          .erp-data-table tbody td > div { min-width: 0; flex-wrap: wrap; }
          .erp-data-table tbody td button { max-width: 100%; }
          .erp-modal { width: calc(100vw - 20px) !important; max-width: calc(100vw - 20px); max-height: 94vh !important; }
          .erp-modal-ai-import,
          .erp-modal-export,
          .erp-modal-ai-description,
          .erp-modal-picker { border-radius: 14px !important; }
          .erp-modal-ai-description > div:first-child { min-width: 0; }
          .ai-description-result-grid > div { grid-template-columns: minmax(92px, 34%) minmax(0, 1fr) !important; }
          .ai-description-result-grid > div > span { min-width: 42px !important; }
          .calendar-week-grid,
          .calendar-week-body { min-width: 860px; }
        }
        ...
        @media (max-width: 560px) {
          ...
          .erp-sidebar { padding-left: 10px !important; padding-right: 10px !important; }
          .erp-panel > div { padding: 12px !important; }
          .erp-content h1 { font-size: 22px !important; }
          .erp-modal { width: calc(100vw - 12px) !important; max-width: calc(100vw - 12px); }
          .erp-modal-ai-description { max-height: 96vh !important; }
          .erp-modal-ai-description > div:first-child { display: flex !important; flex-direction: column !important; }
          .erp-modal-ai-description img { max-width: 100%; height: auto !important; }
          .erp-table-wrap { width: 100%; }
          .erp-data-table tbody td { grid-template-columns: minmax(78px, 34%) minmax(0, 1fr); gap: 7px; font-size: 12px; }
        }
        @media (max-width: 1280px) {
          ...
          .sample-kanban-column { min-width: 178px !important; width: 178px !important; }
        }
        @media (max-width: 820px) {
          ...
          .sample-kanban-board { grid-template-columns: repeat(7, minmax(230px, 1fr)); overflow-x: auto !important; width: max-content; min-width: 100%; }
          .sample-kanban-column { min-width: 230px !important; width: 230px !important; max-height: calc(100vh - 210px) !important; }
        }
      ...
      {showForm && (
        <Panel title={editing.id ? "Edit customer" : "New customer"}>
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            <div className="responsive-grid responsive-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12 }}>
      ...
      {showForm && (
        <Panel title={editing.id ? `Edit ${editing.id}` : "New quote"}>
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div className="responsive-grid responsive-grid-4" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 12 }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
      ...
      {showForm && (
        <Panel title={editing.id ? `Edit ${editing.id}` : "New order"}>
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            <div className="responsive-grid responsive-grid-3" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
              <Field label="Customer">
                <Select value={editing.customerId} onChange={(e) => setEditing({ ...editing, customerId: e.target.value })}>
                  {customers.map((c) => <option key={c.id} value={c.id}>{c.name}</option>)}
                </Select>
...
function SampleImportModal({ samples, saveSamples, customers, productTypes, materialLists, onClose }) {
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(20,24,21,.46)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1100, padding: 20 }}>
      <div className="erp-modal erp-modal-ai-import" onClick={(e) => e.stopPropagation()} style={{ width: "min(980px, 100%)", maxHeight: "88vh", background: COLORS.panel, borderRadius: 18, border: `1px solid ${COLORS.line}`, boxShadow: "0 28px 90px rgba(0,0,0,.25)", overflow: "hidden", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: 18, overflowY: "auto", display: "flex", flexDirection: "column", gap: 14 }}>
          ...
          {parsed && <div className="responsive-grid responsive-grid-4" style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 10 }}>
...
function SampleExportModal({ samples, customers, productTypes, materialLists, materialPreps, initialSampleId, onClose }) {
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "rgba(20,24,22,.46)", zIndex: 1000, display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div className="erp-modal erp-modal-export" style={{ width: "min(1180px, 96vw)", maxHeight: "92vh", background: COLORS.panel, borderRadius: 18, boxShadow: "0 24px 70px rgba(0,0,0,.18)", display: "flex", flexDirection: "column", overflow: "hidden" }}>
...
function AIDescriptionModal({ materialLists, productTypes, onApply, onClose }) {
  ...
  return (
    <div onClick={onClose} style={{ position: "fixed", inset: 0, background: "rgba(20,24,21,.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 1600, padding: 18 }}>
      <div className="erp-modal erp-modal-ai-description" onClick={(e) => e.stopPropagation()} style={{ width: "min(1120px, 100%)", maxHeight: "92vh", background: "#fff", borderRadius: 18, overflow: "hidden", boxShadow: "0 30px 100px rgba(0,0,0,.28)", display: "flex", flexDirection: "column" }}>
        ...
        <div style={{ padding: 18, overflowY: "auto" }}>
          {!result ? (
            <div className="ai-description-input-grid responsive-grid responsive-grid-2" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
              <div>
            ...
            <div>
              ...
              <div className="ai-description-result-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 10 }}>
                {rows.map(([label, key]) => {
      ...
      {showForm && (
        <Panel title={editing.id ? `Edit ${editing.id}` : "New sample"}>
          ...
          <form onSubmit={submit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div className="responsive-grid responsive-grid-5" style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr 1fr", gap: 12 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: 12 }}>
              ...
              <Field label="Required components">
                <div style={{ display: "flex", flexDirection: "column", gap: 8, background: COLORS.bg, borderRadius: 10, padding: 12 }}>
                  ...
                  <div className="responsive-grid responsive-grid-2" style={{ display: "grid", gridTemplateColumns: "repeat(2, minmax(0, 1fr))", gap: 8 }}>
      ...
      <div style={{ display: "flex", gap: 11, minWidth: 0 }}>
        ...
        <div style={{ flex: 1, minWidth: 0 }} onClick={onClick}>
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 6 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 4 }}><button type="button" title="Show sample QR" aria-label="Show sample QR" onClick={(e) => { e.stopPropagation(); onShowQR?.(); }} onMouseDown={(e) => e.stopPropagation()} draggable={false} style={{ width: 25, height: 25, borderRadius: 7, border: `1px solid ${theme.border}`, background: theme.soft, color: theme.head, display: "inline-flex", alignItems: "center", justifyContent: "center", cursor: "pointer" }}><QrCodeIcon size={13} /></button><span style={{ color: "#8B8F94", fontSize: 17, lineHeight: 1, cursor: "pointer", padding: "0 1px" }}>⋯</span></div>
          </div>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 14, minWidth: 0 }}>
      ...
      {view === "week" ? (
        <div style={{ background: COLORS.panel, border: `1px solid ${COLORS.line}`, borderRadius: 14, overflow: "hidden", boxShadow: "0 2px 10px rgba(0,0,0,.035)" }}>
          <div className="calendar-week-grid" style={{ display: "grid", gridTemplateColumns: "190px repeat(7, minmax(0, 1fr))", borderBottom: `1px solid ${COLORS.line}` }}>
          ...
          <div className="calendar-week-grid calendar-week-body" style={{ display: "grid", gridTemplateColumns: "190px repeat(7, minmax(0, 1fr))", minHeight: 450 }}>
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 18, width: "100%", minWidth: 0 }}>
      ...
      {showErpPicker && (
        ...
        >
          <div
            onClick={(e) => e.stopPropagation()}
            className="erp-modal erp-modal-picker" style={{ width: "min(900px, 100%)", maxHeight: "80vh", background: COLORS.panel, borderRadius: 16, border: `1px solid ${COLORS.line}`, boxShadow: "0 24px 70px rgba(0,0,0,.22)", overflow: "hidden", display: "flex", flexDirection: "column" }}
          >
