    ...
    <div className="erp-shell" style={{ fontFamily: FONT_BODY, background: COLORS.bg, color: COLORS.ink }}>
      <style>{`
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .ai-message { max-width:86%; padding:10px 12px; border-radius:13px; background:#fff; border:1px solid #E8E3DD; color:#34302C; font-size:12.5px; line-height:1.55; white-space:pre-wrap; }
        .ai-message-row.user .ai-message { background:#EADDCB; border-color:#DCC6A9; color:#302A24; }
            ...
            <div className="ai-assistant-body">
              ...
              {messages.map((m, i) => (
                <div key={i} className={`ai-message-row ${m.role}`}>
                  <div className={`ai-message ${m.error ? "error" : ""}`}>{m.text}</div>
                </div>
              ))}
